...
<html>
    ...
    <body>
        ...
        <h2 align="center">
            <font style="color: dodgerblue">Cadastrar novo bairro</font>
        </h2>

        <form name="formCadastrar" method="post" action="bairros.jsp?acao=gravar">
            <p>
                Código:
            ...
            <p>
                Bairro:
                <input type="text" name="nome" size="42" maxlength="40" placeholder="Nome do bairro" />
            </p>
